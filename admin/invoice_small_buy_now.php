...
$pdf->SetFont('Courier', 'BI', 8);
$pdf->Cell(40, 4, "#" . $order_row->buy_now_order_id, 0, 1);
...
$pdf->SetX(7);
$pdf->Cell(35, 5, $product_result->product_name, 1, 0, 'C');
$pdf->Cell(10, 5, $order_row->product_quantity, 1, 0, 'C');
...
$pdf->Cell(20, 5, '$ ' . $subtotal_format, 1, 1, 'C');
...
$pdf->Cell(20, 5, '$ ' . $total_format, 1, 1, 'C');
